<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FlightUpdate.aspx.cs" Inherits="Suaah_WWW.Flights.Flights.FlightUpdate" %>
...
&nbsp;<asp:DropDownList ID="airline_lst" runat="server" Height="33px" Width="118px">
        </asp:DropDownList>
        <br />
        <br />
        <asp:Label ID="dAirport_lb" runat="server" Text="Departing Airport"></asp:Label>
&nbsp;<asp:DropDownList ID="DAirport_lst" runat="server" Height="33px" Width="118px">
        </asp:DropDownList>
        <br />
        <br />
        <asp:Label ID="aAirprt_lb" runat="server" Text="Arriving Airport"></asp:Label>
&nbsp;<asp:DropDownList ID="AAirport_lst" runat="server" Height="33px" Width="118px">
        </asp:DropDownList>
        <br />
        <br />
